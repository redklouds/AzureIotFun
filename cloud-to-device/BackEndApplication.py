...
from azure.iot.device import IoTHubDeviceMethod, IoTHubError
from builtins import input

# The service connection string to authenticate with your IoT hub.
# Using the Azure CLI:
# az iot hub show-connection-string --hub-name {your iot hub name} --policy-name service
CONNECTION_STRING = "HostName=pythonIotTest.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=sdQb+03B4y9PIqUa6JNn/dxWQ5YECQNk8Qb6z2cIsNQ="
